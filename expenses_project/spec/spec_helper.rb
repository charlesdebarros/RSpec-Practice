...
RSpec.configure do |config|
  ...
  # framework code, obscuring the application code you’re looking for. RSpec
  # already filters out its own code from the backtrace, and you can easily filter out
  # other gems as well. [37] You’ll have less to read, and you’ll find errors more
  # quickly.
